		...
		return(
			<div id="certLightbox">
				<div className="lightboxAndClose">
					...
					<div id="closeLightbox" className="closeLightbox" onClick={this.closeCert}><FontAwesome id="closeCert" name="close"/></div>
				</div>
			</div>
		);
	}
